...
namespace OpenRA.Mods.RA.Classic.Effects
{
	...
	class Missile : IEffect
	{
		...
		public void Tick( World world )
		{
            ...
            // Commented out the following if-expression to prevent missiles from losing guidance
...
//			if (Args.target.IsValid)
            ...
            // Commented out the following code to prevent missiles from exploding if target dies
